...
export const T = {
  tr: {
    ...
    storageErrorTitle: 'Depolama alanı yetersiz',
    storageErrorMsg: 'Fotoğraf kaydedilemedi. Tarayıcında yeterli depolama alanı kalmamış olabilir.',
    loading: 'Yükleniyor…',
  ...
  en: {
    ...
    storageErrorTitle: 'Not enough storage',
    storageErrorMsg: 'The photo could not be saved. Your browser may be low on available storage.',
    loading: 'Loading…',
